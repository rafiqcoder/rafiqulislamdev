        ...
        <div className="absolute top-0 -right-[0px]">
          ...
          >
            <img
              src={javaScript}
              alt=""
              className="w-[50px] h-[50px] rounded-full absolute left-[150px] -bottom-5"
            />
            <img
              src={typescript}
              alt=""
              className="w-[50px] h-[50px] rounded-full absolute right-[50px] bottom-12"
            />
            <img
              src={mongoose}
              alt=""
              className="w-[50px] h-[50px] rounded-full absolute left-[-40px] bottom-[50%]"
            />
            <img
              src={nextjs}
              alt=""
              className="w-[50px] h-[50px] rounded-full absolute right-[60px] bottom-[80%]"
            />
            <img
              src={node}
              alt=""
              className="w-[50px] h-[50px] rounded-full absolute left-[150px] bottom-[95%] bg-green-800"
            />
          </span>
          <span
